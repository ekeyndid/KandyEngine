...
GameScene::GameScene() :square(nullptr), model(nullptr){
...
bool GameScene::OnCreate()
{
	...
	//	"./Engine/Resources/Textures/CheckerboardTexture.png");
...
//}
	 ...
	 model = new Model("./Engine/Resources/Models/Apple.obj", "./Engine/Resources/Materials/Apple.mtl", 
...
{
	square->Render(CoreEngine::GetInstance()->GetCamera());
}
